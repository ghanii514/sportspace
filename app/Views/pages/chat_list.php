...
<div class="chat-wrapper">
    <div class="chat-card">
        ...
        <div class="chat-body" id="chatBox">
            <div id="loadingIndicator" style="text-align:center; margin-top:50px; color:#9ca3af;">
        ...
        <form class="chat-footer" id="chatForm">
            ...
            <input type="text" name="message" id="messageInput" placeholder="Tulis pesan..." autocomplete="off" required>
    ...
    fetch('<?= base_url('chat/api/messages/') ?>' + roomId)
        ...
        .then(data => {
            ...
            if (data.length === 0) {
                ...
                data.forEach(msg => {
                    const bubbleClass = msg.type === 'user' ? 'msg-user' : 'msg-owner';
                    html += `
